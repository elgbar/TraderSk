...
public class SMerchantAPI implements MerchantAPI {
    ...
    @Override
    public Merchant newMerchant(final String title) {
        checkNotNull(title, "title");
        return new SMerchant(title, false);
    }

    @Override
    public Merchant newMerchant(final String title, final boolean jsonTitle) {
        checkNotNull(title, "title");
    ...
    @Override
    public MerchantOffer newOffer(final ItemStack result, final ItemStack item1, final ItemStack item2) {
    ...
    @Override
    public MerchantOffer newOffer(final ItemStack result, final ItemStack item1) {
