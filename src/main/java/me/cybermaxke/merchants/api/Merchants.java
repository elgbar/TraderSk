...
public class Merchants {
     ...
     * @return The merchant
     */
    public static Merchant newMerchant(final String title) {
     ...
     * @return The merchant
     */
    public static Merchant newMerchant(final String title, final boolean jsonTitle) {
     ...
     */
    public static MerchantOffer newOffer(final ItemStack result, final ItemStack firstItem,
                                         @Nullable final ItemStack secondItem) {
     ...
     */
    public static void set(final MerchantAPI api) {
        if (instance != null) {
